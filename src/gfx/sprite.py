...
class MySprite(pygame.sprite.Sprite):
    ...
    def draw(self, screen: pygame.Surface):
        ...
        self.collision_rect.append(
            self.create_rect(self.rect.centerx, self.rect.centery)
        )
        if self.wrap_around:
            ...
            if y < 0 and abs(y) <= h:
                ...
                self.collision_rect.append(self.create_rect(cx, sh + cy))
            ...
            if y + h > sh and sh - y < h:
                ...
                self.collision_rect.append(self.create_rect(cx, cy - sh))
            ...
            if x < 0 and abs(x) <= w:
                ...
                self.collision_rect.append(self.create_rect(sw + cx, cy))
            ...
            if x + w > sw and sw - x < w:
                ...
                self.collision_rect.append(self.create_rect(cx - sw, cy))
